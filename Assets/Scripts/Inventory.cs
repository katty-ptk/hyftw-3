...
public class Inventory : ScriptableObject {
    public List<Ingredient> ingredients = new List<Ingredient>(); // inventarul va avea o lista cu ingrediente; ele vor fi create tot dintr-o clasa ( Ingredient.cs ), si vor fi Scriptable Objects
